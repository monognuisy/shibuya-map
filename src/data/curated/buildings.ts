...
export const LANDMARKS: Landmark[] = [
  ...
  },
  {
    ...
    connectLevels: [3, 1],
    name: '시부야 스트림',
    desc: '2018년 9월 13일 개업, 180m. 옛 도요코선 지상 승강장 자리에 세워졌다. 3층에서 남측 북쪽 자유통로를 통해 선로 건너 사쿠라스테이지까지 갈 수 있다.',
  ...
  },
  {
    ...
    desc: '사쿠라스테이지 중 선로에 가까운 동. 지상 39층 180m. 남측 북쪽 자유통로의 서쪽 끝이 이 건물 3층에 접속한다. 2023년 11월 30일 준공, 2024년 7월 단계 개업.',
